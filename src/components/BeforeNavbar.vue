<template>
  <div id="before-nav-container" class="d-flex flex-row justify-content-between justify-content-lg-end  align-items-center bg-light border border-muted border-top-0 border-start-0 border-end-0">
      ...
      <div class="m-3 mt-0 mb-0" id="social-media">
          ...
          <a class="m-1" :href="instagram_href" target="_blank">  
            <svg xmlns="http://www.w3.org/2000/svg" id="insta-icon" width="30" height="30" fill="currentColor" class="bi bi-instagram text-dark" viewBox="0 0 16 16">
...
data() {
  return {
    ...
    instagram_href: "https://www.instagram.com/wndev_602/",
    language: '',
  };
},
methods: {
